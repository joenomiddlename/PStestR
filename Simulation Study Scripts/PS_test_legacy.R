# This script stores legacy versions of PStestR functions required for the discrete
# spatial data simulations used in the paper

PSTestInit_sim <- function(type, discrete, positions=NULL, times=NULL,
